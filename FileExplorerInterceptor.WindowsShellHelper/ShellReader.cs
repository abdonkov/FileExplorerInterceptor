...
namespace FileExplorerInterceptor.WindowsShellHelper
{
    ...
    {
        /// <summary>
        /// Tries to get the opened directory data for a given windows explorer window, identified by its handle. If successfull the window is close. Returns an <see cref="OpenedDirectoryData"/> object if inside a directory otherwise null.
        /// </summary>
        /// <param name="windowHandle">The window handle.</param>
        /// <param name="withSelectedItems">Determines whether to check what items are selected in the explorer.</param>
        ...
        /// <summary>
        /// Gets the opened directory data for a given windows explorer window, identified by its handle. Returns an <see cref="OpenedDirectoryData"/> object if inside a directory otherwise null.
        /// </summary>
        /// <param name="windowHandle">The window handle.</param>
        /// <param name="withSelectedItems">Determines whether to check what items are selected in the explorer.</param>
        /// <param name="onFoundItemAction">Action to execute on when directory data is found.</param>
        public static OpenedDirectoryData GetFileExplorerOpenedDirectoryDataIfAny(long windowHandle, bool withSelectedItems = false, Action<object, Type> onFoundItemAction = null)
        {
            try
            {
                ...
                // and COM reference isn't available for .NET Standard class libraries
